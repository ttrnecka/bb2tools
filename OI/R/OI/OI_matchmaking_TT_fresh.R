...
add_ins <- tibble::tribble(
  ...
  "Season 9 - Division 8D", "[GMAN] Don't mess with us", 2273011, "DarkElf", 33, 13,11,2,0,15,"GMAN", 10
)
...
write_csv(for_admins, "week3_admins_fresh.csv")
write_csv(for_posting, "week3_posting_fresh.csv")
